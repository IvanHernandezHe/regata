...
var databaseId = Environment.GetEnvironmentVariable("COSMOS_DATABASE") ?? "regata-nosql";
...
internal static class SeedData
{
    ...
    {
        new("97A097A2-C054-4C68-AF38-8960FB3739AC", "Regata", "/assets/brand/regata-mark2.png", true),
    ...
    {
        new("REG-2055516-1", "Regata", "Suntire Street", "205/55R16", 1899m, 20),
        new("REG-2156516-1", "Regata", "Suntire Touring", "215/65R16", 2599m, 15),
        new("REG-1956515-1", "Regata", "Suntire Eco", "195/65R15", 1599m, 25),
        new("REG-2254018-1", "Regata", "Suntire Sport", "225/40R18", 3299m, 10),
        new("REG-2254517-1", "Regata", "Suntire Pro", "225/45R17", 2899m, 18),
        new("REG-2355018-1", "Regata", "Suntire Pro+", "235/50R18", 3499m, 8),
        new("REG-2657016-1", "Regata", "Suntire AT", "265/70R16", 4099m, 12),
        new("REG-2755519-1", "Regata", "Suntire UHP", "275/55R19", 4699m, 6)
    };
    ...
    private static readonly IReadOnlyList<RimSeed> RimSeeds = new List<RimSeed>
    {
        ...
        new("RIM-REG-17X7.5-5X112-35", "Regata", "StreetFlow", "17x7.5 5x112 ET35", 2799m, 20, 17, 7.5, "5x112", 35, 66.6, "Aluminio", "Gris")
    };
