...
@Component({
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary border-bottom">
    <div class="container align-items-center">
      <a class="navbar-brand brand-lockup fw-bold" routerLink="/">
        <img src="/assets/brand/regata-mark.svg" width="22" height="22" alt="" aria-hidden="true"/>
        <span class="brand-text">Regata</span>
      </a>
      ...
      <div class="d-flex align-items-center gap-1 order-lg-2">
        ...
        <button class="navbar-toggler ms-1" type="button" (click)="toggleMenu()" [attr.aria-expanded]="menuOpen" aria-controls="navRegata">
          <span class="navbar-toggler-icon"></span>
        </button>
      </div>

      <div class="collapse navbar-collapse order-lg-1" id="navRegata" [class.show]="menuOpen">
